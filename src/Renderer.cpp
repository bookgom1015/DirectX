...
void Renderer::CreateRtvAndDsvDescriptorHeaps() {
	...
	rtvHeapDesc.NumDescriptors = SwapChainBufferCount + mAdditionalRtvDescriptors;
	...
	dsvHeapDesc.NumDescriptors = 1 + mAdditionalDsvDescriptors;
...
void Renderer::BuildRootSignature() {
	...
	ThrowIfFailed(md3dDevice->CreateRootSignature(
		...
		IID_PPV_ARGS(mRootSignatures["opaque"].GetAddressOf())));
}
...
void Renderer::BuildPSO() {
	...
	opaquePsoDesc.pRootSignature = mRootSignatures["opaque"].Get();
	opaquePsoDesc.VS = {
