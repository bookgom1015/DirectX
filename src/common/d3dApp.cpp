...
bool D3DApp::InitMainWindow() {
	...
	mClientPosX = static_cast<int>((primaryMonitorWidth - mClientWidth) * 0.5f);
	mClientPosY = static_cast<int>((primaryMonitorHeight - mClientHeight) * 0.5f);

	mhMainWnd = CreateWindow(L"MainWnd", mMainWndCaption.c_str(),
		WS_OVERLAPPEDWINDOW, mClientPosX, mClientPosY, width, height, 0, 0, mhAppInst, 0);
	if (!mhMainWnd)	{
