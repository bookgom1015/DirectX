...
#if defined(Ex1)
	bricks0->FresnelR0 = XMFLOAT3(0.9f, 0.9f, 0.9f);
...
#if defined(Ex1)
	tile0->FresnelR0 = XMFLOAT3(0.9f, 0.9f, 0.9f);
	tile0->Roughness = 0.9f;
#else
...
#if defined(Ex1)
	mirror0->FresnelR0 = XMFLOAT3(0.1f, 0.1f, 0.1f);
	mirror0->Roughness = 0.8f;
#else
...
#if defined(Ex1)
	skullMat->FresnelR0 = XMFLOAT3(0.9f, 0.9f, 0.9f);
