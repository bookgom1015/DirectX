...
public:
	...
	virtual ~TreeBillboardsApp();

private:
	TreeBillboardsApp(const TreeBillboardsApp& src) = delete;
	TreeBillboardsApp(TreeBillboardsApp&& src) = delete;
	TreeBillboardsApp& operator=(const TreeBillboardsApp& rhs) = delete;
	TreeBillboardsApp& operator=(TreeBillboardsApp&& rhs) = delete;
