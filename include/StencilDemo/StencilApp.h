...
private:
	StencilApp(const StencilApp& src) = delete;
	StencilApp(StencilApp&& src) = delete;
	StencilApp& operator=(const StencilApp& rhs) = delete;
	StencilApp& operator=(StencilApp&& rhs) = delete;
...
private:
	...
	RenderItem* mReflectedShadowRitem = nullptr;
