...
public:
	...
	virtual ~DynamicCubeMapApp();

private:
	DynamicCubeMapApp(const DynamicCubeMapApp& src) = delete;
	DynamicCubeMapApp(DynamicCubeMapApp&& src) = delete;
	DynamicCubeMapApp& operator=(const DynamicCubeMapApp& rhs) = delete;
	DynamicCubeMapApp& operator=(DynamicCubeMapApp&& rhs) = delete;
