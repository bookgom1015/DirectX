...
private:
	QuatApp(const QuatApp& src) = delete;
	QuatApp(QuatApp&& src) = delete;
	QuatApp& operator=(const QuatApp& rhs) = delete;
	QuatApp& operator=(QuatApp&& rhs) = delete;
...
private:
	...
	DirectX::XMFLOAT3 mBaseLightDirection = { 0.57735f, -0.57735f, 0.57735f };
};