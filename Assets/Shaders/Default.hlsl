...
VertexOut VS(VertexIn vin, uint instanceID : SV_InstanceID) {
	...
	for (int i = 0; i < 8; ++i) {
		...
		float4 r1 = gAnimationsDataMap.Load(int3(rowIndex, colIndex, 0));
		float4 r2 = gAnimationsDataMap.Load(int3(rowIndex + 1, colIndex, 0));
		float4 r3 = gAnimationsDataMap.Load(int3(rowIndex + 2, colIndex, 0));
		float4 r4 = gAnimationsDataMap.Load(int3(rowIndex + 3, colIndex, 0));
